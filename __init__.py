...
# ##### MJM_Builds ScrapMechanic Mod #####
#
# This program has been modified to add custom bone axis correction matrix
# for correcting the angle of character steering animations in the game
# ScrapMechanic.
# My additional code is tagged with the comment 'MJM ScrapMechanic Mod'
#
##########################################
...
class ExportFBX(bpy.types.Operator, ExportHelper):
    ...
    is_scrapmechanic_driverseat: BoolProperty( #MJM ScrapMechanic Mod
            name="ScrapMechanic Driverseat?",
            description="Is this a ScrapMechanic Driverseat?",
            default=False,
            )
    scrapmechanic_steeringwheel_angle: FloatProperty( #MJM ScrapMechanic Mod
            name="Steering Tilt Angle",
            description="0 = horizontal (car), 90 = vertical (bike)",
            min=0.0, max=90.0,
            default=0.0,
            )
...
############# MJM ScrapMechanic Mod ################
class FBX_PT_export_scrapmechanic(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Scrap Mechanic"
    bl_parent_id = "FILE_PT_operator"
    ...
    def draw(self, context):
        ...
        layout.prop(operator, "is_scrapmechanic_driverseat")
        layout.prop(operator, "scrapmechanic_steeringwheel_angle")
##################################################
...
classes = (
    ...
    ExportFBX,
    FBX_PT_export_main,
    FBX_PT_export_scrapmechanic, #MJM ScrapMechanic Mod
