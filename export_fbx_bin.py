...
def save_single(operator, scene, depsgraph, filepath="",
                ...
                is_scrapmechanic_driverseat=False, # MJM Scrapmechanic Mod
                scrapmechanic_steeringwheel_angle=0.0, # MJM Scrapmechanic Mod
                **kwargs
                ):
    ...
    #MJM Scrapmechanic Mod - bone correction matrix override
    if is_scrapmechanic_driverseat == True:
        ang = scrapmechanic_steeringwheel_angle
        y1 = ang / 90
        y2 = (ang / 90) - 1
        z1 = 1 - (ang / 90)
        z2 = ang / 90
        bone_correction_matrix = Matrix([[1, 0, 0, 0], [0, y1, y2, 0], [0, z1, z2, 0], [0, 0, 0, 1]])
        bone_correction_matrix_inv = bone_correction_matrix.inverted()
